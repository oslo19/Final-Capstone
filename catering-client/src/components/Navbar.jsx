...
const Navbar = () => {
  ...
  <form
    ...
    className="relative flex-1 mx-auto max-w-md"
  >
    <input
      type="search"
      id="search-query"
  ...
  <div className="flex items-center space-x-4">
    ...
    {user ? (
      ...
      <button
        ...
        className="hidden lg:inline-flex items-center px-6 py-2 text-prime bg-orange rounded-full"
      >
        <FaRegUser /> Login
      </button>
    )}
      ...
      >
        <div className="container mx-auto px-4 py-6">
          ...
          <ul className="flex flex-col space-y-4 items-center">{navItems}</ul>
        </div>
      </div>
    </header>
  );

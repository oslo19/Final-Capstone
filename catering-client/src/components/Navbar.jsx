...
const Navbar = () => {
  ...
  const navItems = (
    <>
      ...
      <li tabIndex={0}>
        <a href="/menu" className="hover:text-prime s">Menu</a>
      </li>
      <li tabIndex={0}>
        ...
        <div className="navbar-end ">
         ...
         <label
...

          {
            user ? <>
              <Profile user={user} />
            </> : <button onClick={() => navigate('/login', { state: { from: location } })} className=" flex items-center gap-2 rounded-full px-6 bg-orange text-prime"> <FaRegUser /> Login</button>
          }

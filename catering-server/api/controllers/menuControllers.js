...
const postMenuItem = async (req, res) => {
    const { menuItemId, name, recipe, image, category, quantity, price, menuTypes } = req.body;
    const newItem = { menuItemId, name, recipe, image, category, quantity, price, menuTypes };
    try {
